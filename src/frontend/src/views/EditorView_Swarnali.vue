<template>
    ...
    <!-- [ADDED: KeyLoader overlay, called like UploadCard / ElementMenu] -->
    ...
    <v-container fluid>
        <v-row v-if="store.tabs.length > 0">
            ...
            <!-- [ADDED: Button to open KeyLoader overlay] -->
            <v-col cols="12" sm="auto" v-if="store.tree.length > 0">
...
// [ADDED: Import KeyLoader.vue from the same directory as UploadCard.vue]
...
export default {
    ...
    data() {
        return {
            ...
            // [ADDED: Controls the KeyLoader overlay]
            showKeyLoader: false,
            // [ADDED: end]
    ...
    components: {
        ...
        // [ADDED: Register KeyLoader component]
        KeyLoader
        // [ADDED: end]
    },
    computed: {

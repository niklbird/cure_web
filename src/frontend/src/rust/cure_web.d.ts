...
export interface InitOutput {
  ...
  readonly state_add_node: (a: number, b: number, c: number, d: number, e: number) => [number, number];
  ...
  readonly state_get_tree_data: (a: number) => [number, number];
